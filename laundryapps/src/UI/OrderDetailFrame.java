...
public class OrderDetailFrame extends JFrame {
    public void mouseClicked(MouseEvent e) {
        ...
        if (selectedRow >= 0 && selectedRow < tableServices.getRowCount()) {
            String orderId = tableServices.getValueAt(selectedRow, 0).toString();
            // ... other code to retrieve and process data
        } else {
            JOptionPane.showMessageDialog(this, "Silakan pilih baris layanan terlebih dahulu.");
        }
    }
    ...
    private JTextField txtTglAmbil; 
    ...
    public OrderDetailFrame() {
        ...
        tableServices.addMouseListener(new MouseInputAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow != -1) {              
                    String orderId = tableServices.getValueAt(selectedRow, 0).toString();
                    String serviceName = tableServices.getValueAt(selectedRow, 1).toString(); 
                    String status = tableServices.getValueAt(selectedRow, 2).toString(); 
                    String price = tableServices.getValueAt(selectedRow, 3).toString(); 
                    String quantity = tableServices.getValueAt(selectedRow, 4).toString(); 
                    String harga_pcs = tableServices.getValueAt(selectedRow, 5).toString(); 
                    

                    txtOrderId.setText(orderId);
                    txtTotalOrder.setText(price);
                    lblNilaiTotal.setText(price); 
	...
	public void setCostumer(Costumer selectedCostumer) {
